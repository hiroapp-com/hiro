...
<head>
	...
	<div class="content" style="width: 100%;max-width: 540px;text-align: left;margin: 30px auto 0 auto;	">
		...
		<div class="postnote" style="color: #999999;font-family: 'Tahoma', sans-serif;font-size: 13px;margin: 0 31px 0 31px;padding-bottom: 20px;border-bottom: 1px dotted #dddddd;display: block;">{% if invitee %}Thanks for using <a href="https://www.hiroapp.com" class="greylink" class="text-decoration: none;color: #333334 !important;">Hiro</a>, please let us know if there's anything we could do better.{% else %}<a href="https://www.hiroapp.com" class="greylink" class="text-decoration: none;color: #333334 !important;">Hiro</a> is the best way to keep notes with friends & colleagues, or store them safely for yourself.{% endif %}</div><br />
