...
<head>
	...
	<div class="content" style="width: 100%;max-width: 540px;text-align: left;margin: 30px auto 0 auto;	">
		...
		<div class="note" style="background-color: #ffffff;border: 1px solid #dddddd;display: block;min-height: 150px;margin-top: 5px;max-height: 240px;overflow: hidden;box-shadow: 0 5px 17px -12px #000;"><br />
			<a href="{{url}}{% if not invitee %}#token={{token}}{% endif %}" class="noteheader" style="font-family: 'Chau Philomene One', sans-serif;font-size: 30px;margin: 0px 30px 0 30px;text-decoration:none;color: #000001 !important;display: block;">{{ doc.title }}</a><br />
			<a href="{{url}}{% if not invitee %}#token={{token}}{% endif %}" class="notetext" style="font-family: 'PT Serif', serif;display: block;margin-top: 0px;font-size: 17px;line-height: 30px;margin: 0 30px 0 30px;text-decoration:none;color: #000001 !important;">{{ doc.excerpt }}</a>
		</div><br /> 
		<div class="cto" style="margin: 5px 30px 3px 30px;text-align: center;"><a href="{{url}}{% if not invitee %}#token={{token}}{% endif %}" class="ctobutton" style="color:#ffffff;font-weight: normal;padding: 10px 6px 9px 6px;height: auto;border-radius: 3px;-webkit-border-radius: 3px;-moz-border-radius: 3px;-o-border-radius: 3px;border: 1px solid rgba(0,0,0,0.25);box-shadow: 0px 1px 3px rgba(0,0,0,0.35), inset 0px 1px 1px rgba(255,255,255,0.30);-webkit-box-shadow: 0px 1px 3px rgba(0,0,0,0.35), inset 0px 1px 1px rgba(255,255,255,0.30);-moz-box-shadow: 0px 1px 3px rgba(0,0,0,0.35), inset 0px 1px 1px rgba(255,255,255,0.30);-o-box-shadow: 0px 1px 3px rgba(0,0,0,0.35), inset 0px 1px 1px rgba(255,255,255,0.30);text-decoration: none !important;opacity: 0.9;text-shadow: none;display: block;background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(0, 0, 0, 0)), color-stop(100%, rgba(0, 0, 0, 0.2)));background-image: -webkit-linear-gradient(top, transparent, rgba(0,0,0,.2));background-image: -moz-linear-gradient(top, transparent, rgba(0,0,0,.2));background-image: -ms-linear-gradient(top, transparent, rgba(0,0,0,.2));background-image: -o-linear-gradient(top, transparent, rgba(0,0,0,.2));background-image: linear-gradient(to bottom, transparent, rgba(0,0,0,0.2));background-color: #3c6198;text-align: center;font-family: 'Chau Philomene One', sans-serif;font-size: 20px;">Join In</a></div><br />
